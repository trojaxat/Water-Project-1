  ...
  if(empty($username) || empty($Food) || empty($Amount) || empty($Cooking) || empty($Date)) {
	  ...
	  exit();
		    ...
		    exit();
			  ...
			  $sql = "SELECT * FROM water_login WHERE username='$username'";
			  ...
			  if ($resultCheck > 0) {
                  ...
                  $sql = "INSERT INTO water_login (username, Food, Amount, Cooking, Date) VALUES ('$username', '$Food', '$Amount', '$Cooking', '$Date');";
